...
@section('title', '銀行口座登録ページです')
@section('keywords', '銀行口座登録')
@section('description', '銀行口座が登録できます。')

@section('content')

<section class="lg-box py-4 content-width">
    <div class="container mt-5 p-lg-5 bg-white w-sm-75 py-5">
        <h2 class="center">口座登録</h2>
        @if(count($errors) > 0)
        <div>
            <ul>
        ...
        @endif
        <form action="{{ route('transfer.store', ['id' => $id])}}" method="post" enctype="multipart/form-data">
            @csrf
            <!--氏名-->
            <div class="form-row mb-4 justify-content-center">
                <div class="col-md-6 form-group @if(!empty($errors->first('bank_name'))) has-error @endif">
                    ...
                    <input type="text" class="form-control" name="bank_name" placeholder="金融機関名" vulue="{{old('bank_name')}}" required>
            ...
            <div class="form-row mb-4 justify-content-center">
                <div class="col-md-6 mb-3 form-group @if(!empty($errors->first('branch_name'))) has-error @endif">
                    ...
                    <input type="text" class="form-control" name="branch_name" placeholder="支店名" vulue="{{old('branch_name')}}" required>
            ...
            <div class="form-group row justify-content-center">
                <div class="mb-4">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="customRadioInline1" name="deposit_type" class="custom-control-input" value="普通" @if(old('deposit_type')=="普通" ) checked @endif>
                        <label class="custom-control-label" for="customRadioInline1">普通</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="customRadioInline2" name="deposit_type" class="custom-control-input" value="当座" @if(old('deposit_type')=="当座" ) checked @endif>
            ...
            <div class="form-row mb-4 justify-content-center">
                <div class="col-md-6 form-group @if(!empty($errors->first('bank_num'))) has-error @endif">
                    ...
                    <input type="text" class="form-control" name="bank_num" value="{{old('bank_num')}}" placeholder="口座番号" required>
            ...
            <div class="form-row mb-4 justify-content-center">
                <div class="col-md-6 mb-3 form-group @if(!empty($errors->first('name'))) has-error @endif">
                    ...
                    <input type="text" class="form-control" name="name" value="{{old('name')}}" placeholder="口座名義" required>
